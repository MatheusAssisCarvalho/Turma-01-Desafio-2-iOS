...
public final class GithubService {
    ...
    public func getPullRequestOf(_ repository: Repository, completion: @escaping(Result<[PullRequest]>) -> Void) {
        self.getResourceOf(repository, resource: .pulls, completion: completion)
    }
